...
- [x] Task 1: Freeze source artifacts and manifest
...
- [x] Task 2: Implement evidence/block parser with TDD
...
- [x] Task 3: Build and validate Master-5337
...
- [x] Task 4: Implement conservative reason codes
...
- [x] Task 5: Implement ontology and exact-sequence grouping
...
- [x] Task 6: Generate Full/Core/Challenge and audit report
...
- [x] Task 7: Implement leakage-safe prompt/response schemas
...
- [x] Task 8: Implement scorer with hand-calculated fixtures
...
- [x] Task 9: Implement resumable runner ledger
